...
public class Database extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String query3 = "create table orderplace(username text, fullname text, address text, contactno text, pincode text, date text, time text, amount float, otype text)";
        db.execSQL(query3);
    }
