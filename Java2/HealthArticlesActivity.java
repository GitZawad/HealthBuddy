...
public class HealthArticlesActivity extends AppCompatActivity {
    ...
    private String[][] health_details = {
            {"Making Daily", "", "", "", "Click More Details"},
            {"More care of COVID-19","","","","Click More Details"},
            {"Stop Seeking","","","","Click More Details"},
            {"Heartbeat Cranes","","","","Click More Details"},
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = findViewById(R.id.buttonBackHealthArticles);
        ...
        sa = new SimpleAdapter(this, list,
                ...
                new String[]{"line1", "line2", "line3", "list4", "list5"},
