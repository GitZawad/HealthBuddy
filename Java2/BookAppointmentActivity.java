...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    TextView tv;
    Button btn, dateButton, timeButton, bookAppointment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv = findViewById(R.id.textViewLTBBookApp);
        ed1 = findViewById(R.id.editTextLTBAppFullName);
        ed2 = findViewById(R.id.editTextLTBAppAddress);
        ed3 = findViewById(R.id.editTextLTBPinCode);
        ed4 = findViewById(R.id.editTextLTBAPPContactNumber);

        btn = findViewById(R.id.buttonAppBack);
        bookAppointment = findViewById(R.id.buttonBookAppointment);

        dateButton = findViewById(R.id.buttonBMCartSelectDate);
